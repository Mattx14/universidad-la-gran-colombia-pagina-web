...
<head>
    ...
    <title>Detalle Solicitud #<?php echo str_pad($solicitud['id'], 4, '0', STR_PAD_LEFT); ?> - UGC</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="detalle-solicitud-header">
            <h1>📋 Solicitud #<?php echo str_pad($solicitud['id'], 4, '0', STR_PAD_LEFT); ?></h1>
        ...
        <div class="button-group" style="margin-top: 2rem;">
            <a href="jefe_dashboard.php" class="btn-primary">← Volver al Dashboard</a>
        </div>
    </div>
