...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'aprobar' || $accion === 'rechazar') {
        ...
        $stmt = $conn->prepare("UPDATE solicitudes SET check_jefe = ? WHERE id = ?");
        ...
        if ($stmt->execute()) {
            ...
            // REDIRECCIONAR A DETALLE EN VEZ DEL DASHBOARD
            header('Location: ver_solicitud_jefe.php?id=' . $solicitud_id);
            exit;
        } else {
...
// Verificar si puede revisar (check_jefe debe ser NULL)
$puede_revisar = is_null($solicitud['check_jefe']);
...
<body>
    <div class="header-ugc">
        ...
        <div class="user-info">
            <span><strong><?php echo htmlspecialchars($user['nombre']); ?></strong> (Jefe)</span>
    ...
    <div class="dashboard-container">
        <div class="breadcrumb">
            <a href="jefe_dashboard.php">← Volver al Dashboard</a>
        </div>
        ...
        <!-- Botones de Decisión -->
        <div class="content-section">
            <h2>Decisión del Jefe Inmediato</h2>

            <?php if ($puede_revisar): ?>
                <p style="margin-bottom: 1.5rem; color: #666;">
                    Como Jefe Inmediato, usted realiza la primera aprobación de esta solicitud.
                    Si aprueba, la solicitud pasará a Talento Humano para aprobación final.
                </p>
        ...
        <div class="button-group" style="margin-top: 2rem;">
            <a href="jefe_dashboard.php" class="btn-secondary">← Volver al Dashboard</a>
        </div>
    </div>
